...
int main()
{
    Cpu* a1=new Cpu("cpu",3, "intel", "i9", 13 ,"ape",50, 500, "pollo", "mele");
    Cpu* a2=new Cpu("cpu",3, "intel", "i7", 13 ,"ape",50, 500, "pollo", "mele");
    Cpu* a3=new Cpu("cpu",3, "intel", "i5", 13 ,"ape",50, 500, "pollo", "mele");
    Cpu* a4=new Cpu("cpu",3, "intel", "i3", 13 ,"ape",50, 500, "pollo", "mele");
    Cpu* a5=new Cpu("cpu",3, "intel", "pentium", 13 ,"ape",50, 500, "pollo", "mele");
    Gpu* g1=new Gpu("gpu",3, "Nvidia", "1060", 13 , "random", 16, 51);
    Gpu* g2=new Gpu("gpu",3, "Nvidia", "1070", 13 , "random", 16, 51);
    Gpu* g3=new Gpu("gpu",3, "Nvidia", "1080", 13 , "random", 16, 51);
    Gpu* g4=new Gpu("gpu",3, "Nvidia", "Titan", 13 , "random", 16, 51);
    Case* g5=new Case("case",3, "ciao", "tony",14, "ggg", "abc");
    SchedaMadre* g6=new SchedaMadre( "SchedaMadre" , 3 , "bello", "mario", 25, "abc", "ccdf", 23, 28);
