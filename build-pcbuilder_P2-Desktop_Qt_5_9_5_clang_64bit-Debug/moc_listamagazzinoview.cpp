...
QT_MOC_LITERAL(6, 78, 17), // "get_quantita_item"
QT_MOC_LITERAL(7, 96, 21), // "richiesta_elimina_obj"
QT_MOC_LITERAL(8, 118, 13), // "item_selected"
QT_MOC_LITERAL(9, 132, 16) // "QListWidgetItem*"

    },
    "ListaMagazzinoView\0closing\0\0"
    "delete_obj_to_controller\0std::string\0"
    "item_to_view\0get_quantita_item\0"
    "richiesta_elimina_obj\0item_selected\0"
    "QListWidgetItem*"
};
...
void ListaMagazzinoView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->get_quantita_item((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 4: _t->richiesta_elimina_obj(); break;
        case 5: _t->item_selected((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ListaMagazzinoView::*_t)(std::string );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ListaMagazzinoView::get_quantita_item)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void ListaMagazzinoView::get_quantita_item(std::string _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
