...
QT_MOC_LITERAL(4, 53, 7), // "closing"
QT_MOC_LITERAL(5, 61, 21), // "richiesta_add_ogg_gpu"
QT_MOC_LITERAL(6, 83, 21), // "richiesta_add_ogg_cpu"
QT_MOC_LITERAL(7, 105, 21), // "richiesta_add_ogg_psu"
QT_MOC_LITERAL(8, 127, 21), // "richiesta_add_ogg_ram"
QT_MOC_LITERAL(9, 149, 21), // "richiesta_add_ogg_rom"
QT_MOC_LITERAL(10, 171, 22), // "richiesta_add_ogg_case"
QT_MOC_LITERAL(11, 194, 29) // "richiesta_add_ogg_schedamadre"

    },
    "SelectAddObjectView\0signal_tipo_ogg_add\0"
    "\0std::string\0closing\0richiesta_add_ogg_gpu\0"
...
void SelectAddObjectView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->richiesta_add_ogg_gpu(); break;
        case 3: _t->richiesta_add_ogg_cpu(); break;
        case 4: _t->richiesta_add_ogg_psu(); break;
        case 5: _t->richiesta_add_ogg_ram(); break;
        case 6: _t->richiesta_add_ogg_rom(); break;
        case 7: _t->richiesta_add_ogg_case(); break;
        case 8: _t->richiesta_add_ogg_schedamadre(); break;
        default: ;
        }
        ...
        {
            typedef void (SelectAddObjectView::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SelectAddObjectView::closing)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void SelectAddObjectView::closing()
{
